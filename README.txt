...
== IMPORTANT NOTICE OCTOBER 15 2018 ==

Due to some recent changes with the Tumblr v1 API, this plugin may not
successfully fetch and display any posts. A new version (0.2.11) has been
pushed out to avoid filling up your error logs with messages about this,
but a fix to successfully fetch posts will take a little longer.
...
= 0.2.11 =
* Suppressed large volumes of XML warnings, generated by Tumblr hiding their
  v1 API behind a GDRP warning page. This doesn't actually resolve the issue,
  but will stop your error log filling up with masses of messages.
